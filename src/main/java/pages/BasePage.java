...
public abstract class BasePage {
    ...
    public void clickObject(WebElement webElement){
        waitForWebElementToBeClickable(webElement);
        webElement.click();
        logger.info("Clicked on webelement: {}",webElement.getText());
    }

    public void sendKeysToObject(WebElement webElement, String message){
        waitForWebElementToBeVisable(webElement);
        webElement.clear();
        webElement.sendKeys(message);
        logger.info("Typed message {} to webelement: {}", message,webElement.getAttribute("class"));
    }
